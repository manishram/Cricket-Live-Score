        ...
        <View style={styles.rect4}>
          ...
          <View style={styles.rect5Filler}>
            <View style={styles.endOfOver15Row}>
              <Text style={styles.endOfOver15}>End of Over 15</Text>
              <View style={styles.ellipse5Stack}>
                <Svg viewBox="0 0 15.05 15.05" style={styles.ellipse5}>
                  <Ellipse
                    strokeWidth={0}
              ...
              <View style={styles.ellipseStack}>
                <Svg viewBox="0 0 15.05 15.05" style={styles.ellipse}>
                  <Ellipse
                    strokeWidth={0}
              ...
              <View style={styles.ellipse1Stack}>
                <Svg viewBox="0 0 15.05 15.05" style={styles.ellipse1}>
                  <Ellipse
                    strokeWidth={0}
                    fill="rgba(1,34,154,1)"
                    cx={8}
              ...
              <View style={styles.ellipse2Stack}>
                <Svg viewBox="0 0 15.05 15.05" style={styles.ellipse2}>
                  <Ellipse
                    strokeWidth={0}
                    fill="rgba(196,196,196,1)"
                    cx={8}
              ...
              <View style={styles.ellipse3Stack}>
                <Svg viewBox="0 0 15.05 15.05" style={styles.ellipse3}>
                  <Ellipse
                    strokeWidth={0}
                    fill="rgba(1,34,154,1)"
                    cx={8}
              ...
              <View style={styles.ellipse4Stack}>
                <Svg viewBox="0 0 15.05 15.05" style={styles.ellipse4}>
                  <Ellipse
                    strokeWidth={0}
                    fill="rgba(196,196,196,1)"
                    cx={8}
            ...
            <View style={styles.endOfOver16ColumnRow}>
              <View style={styles.endOfOver16Column}>
                ...
                <View style={styles.ellipse6Stack}>
                  <Svg viewBox="0 0 15.05 15.05" style={styles.ellipse6}>
                    <Ellipse
                      strokeWidth={0}
                      fill="rgba(196,196,196,1)"
                      cx={8}
            ...
            <View style={styles.endOfOver17ColumnRow}>
              <View style={styles.endOfOver17Column}>
                ...
                <View style={styles.loremIpsum7Stack}>
                  ...
                  <Svg viewBox="0 0 15.05 15.05" style={styles.ellipse7}>
                    <Ellipse
                      strokeWidth={0}
                      fill="rgba(1,34,154,1)"
                      cx={8}
